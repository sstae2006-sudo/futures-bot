...
| `tools/` | Data-maintenance/ops scripts (contract building, schema fixes, backup/merge/restore, and — 2026-07-27 — `migrate_to_timescaledb.py`/`backup_timescaledb.py` for team-deployment mode), plus — 2026-07-28 — `work_item_cli.py` (terminal front end for the Active Work Registry; see section 6's step 7). Not part of the installable package. |
